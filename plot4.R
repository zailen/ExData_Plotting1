...
# plot 1,1
plot(hh_subset$Global_active_power, type="l", ylab="Global Active Power", xaxt='n', xlab="")
axis(1, at=c(0, 1441, 2881), labels=c("Thu", "Fri", "Sat"))

#plot 1,2
plot(hh_subset$Voltage, type="l", ylab="Voltage", xaxt='n', xlab="datetime")
axis(1, at=c(0, 1441, 2881), labels=c("Thu", "Fri", "Sat"))

# plot 2,1
plot(hh_subset$Sub_metering_1, type="l", ylab="Energy sub metering", xaxt='n', xlab="")
...
# plot 2,2
plot(hh_subset$Global_reactive_power, ylab="Global_reactive_power", type="l", xaxt='n', xlab="datetime")
axis(1, at=c(0, 1441, 2881), labels=c("Thu", "Fri", "Sat"))
